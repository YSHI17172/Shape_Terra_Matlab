% TODO
% What is CLSCLS output?
function clscls=FindTipsTest(folderpath)
...
for flclsind=1:length(similold)
    t_iter = tic;
    ScreenComment('',['Finding tips for ' num2str(100*similold(flclsind))...
        '% similarity']);
    ...
    ScreenComment('',['Elapsed time finding tips ' ...
        num2str(100*similold(flclsind)) '% similarity: ' ...
        num2str(t_elapsed) '[s]'])
end
    
flclsind=ind; % error hier
