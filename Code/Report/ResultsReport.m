%% Basic HTML results report
% Hier probeer ik de tips plot te laten zien in HTML

load('partrecord.mat','clscls','coord','tri','clusters','flclsind');
createfigure(clscls,clusters,coord,flclsind,tri);
